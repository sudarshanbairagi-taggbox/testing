...
export default class Media extends PureComponent {
  ...
  render() {
    ...
    const multiImagesClass = ((itemData.imageList && itemData.imageList.length) > 0 && (itemData.type === 3 || itemData.type === 5)) ? 'tb_sp_multi_images_ico_bottom' : 'tb_sp_multi_images_ico'
    const imageStyle = {
    ...
    return (
      <div className="tb_sp_media_wrap">
        ...
        {mediaType ? isYoutubePost ? <div className="tb_sp_youtube_ico tb__icon tb-youtube"> </div> : <div className="tb_sp_video_ico tb__icon tb-video"> </div> : ''}
        <div className="tb_sp_image" style={imageStyle}> </div>
